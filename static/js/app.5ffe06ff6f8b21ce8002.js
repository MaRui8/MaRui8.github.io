    ...
    NHnr: function(t, e, i) {
          ...
          , $ = {
            ...
            actions: {
                Authentication: function(t, e) {
                    ...
                    y(e).then(function(t) {
                        var o = t.data;
                        j.state.configuration.githubUsername == o.login ? (i("SET_TOKEN", e),
          ...
          , z = {
            ...
            actions: {
                LocalReload: function(t, e) {
                    (0,
                    t.commit)("SET_CONFIGURATION", e)
                },
                Init: function(t) {
                    var e = t.commit
                      , i = void 0;
                    (i = window.XMLHttpRequest ? new XMLHttpRequest : new ActiveXObject("Microsoft.XMLHTTP")).open("GET", "../../../static/configuration.json", !1),
                    i.send(),
            ...
            methods: {
                ...
                onSubmit: function() {
                    ...
                    this.$refs.tokenForm.validate(function(e) {
                        e && (t.$store.dispatch("Authentication", t.tokenForm.token),
                        "function" == typeof t.handleClose && t.handleClose())
                    }),
                    this.show = !1
                }
            }
          ...
          , H = {
            ...
            methods: {
                selectTopbar: function(t) {
                    switch (this.topbar.active = "" == this.topbar.active ? " " : "",
                    t) {
                    case "#githubHome":
        ...
        var ct = i("VU/8")(lt, st, !1, function(t) {
          ...
          , ut = {
            ...
            mounted: function() {
                var t = this;
                this.token ? (this.loading = !0,
                this.form.id = this.$route.params.id,
                G(this.form.id).then(function(e) {
                    var i = e.data;
                    for (var n in i.files) {
                        t.form.title = n,
            ...
            methods: {
                ...
                search: function() {
                    for (var t = 0; t < this.projects.length; t++)
                        this.projects[t].hide = this.projects[t].name.indexOf(this.searchKey) < 0
                },
                goDetails: function(t) {
            ...
            methods: {
                submit: function() {
                    ...
                    this.$refs.configureForm.validate(function(e) {
                        e && (t.submitButton.loading = !0,
                        t.submitButton.disabled = !0,
                        _t(t.configure, t.configureSha).then(function(e) {
                            var i = e.data;
        ...
        se.beforeEach(function(t, e, i) {
            n.default.prototype.$setTitle(t.meta.title),
            i()
        });
        var ce = se
          , ue = i("OS1Z")
        ...
        n.default.use(ge.a),
        n.default.use(de.a),
        n.default.prototype.$markdown = function(t) {
